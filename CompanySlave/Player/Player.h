...
private:
	...
	std::array<Vec3, 7> gravity = { Vec3{ 0.0f,0.3f,0.0f }, { 0.0f,0.1f,0.0f }, { 0.0f,0.4f,0.0f }, { 0.0f,0.2f,0.0f }, { 0.0f,0.1f,0.0f }, { 0.0f,0.2f,0.0f }, { 0.0f,0.3f,0.0f } };		//角度
